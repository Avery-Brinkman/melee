...
void fn_80039618(int arg0)
{
    ...
    u32* temp_r18;
    u8* temp_r19;
    struct pl_800386D8_1B0_t* temp_r23;
    u8* var_r3_3;
    u8* var_r3_4;
    int i;
    PAD_STACK(8);
    ...
    for (var_r4_2 = 0x40; var_r4_2 <= 0x62; ++var_r4_2) {
        temp_r0_2 = temp_r23->x0[var_r4_2];
        var_r5 += temp_r0_2;
        switch (var_r4_2) {
        case 0x42:
        case 0x46:
    ...
    if (var_r5 != 0U) {
        if ((u32) temp_r25 == temp_r23->x0[0x62]) {
            setFlag(arg0, 0x95);
    ...
    for (var_r28 = 0; var_r28 < 6; ++var_r28) {
        for (var_r31 = 1; var_r31 <= 0x10; ++var_r31) {
            if ((pl_80037B2C(temp_r27, var_r28, var_r31) == 0) &&
...
loop_125:
          ...
          0)))
    {
        ...
        temp_r21_40 = fn_80038700(&temp_r27->total_attack_count, 1, 0x10);
        temp_r3_17 = fn_80038700(&temp_r27->x358, 1, 0x10);
